-- Native LSP-Setup
-- TODO: make mappings all the same for LSPs
...
require'lspconfig'.gopls.setup{
    ...
    on_attach = function()
       ...
       vim.keymap.set("n", "<leader>db", vim.diagnostic.goto_prev, {buffer=0}) --in "n"ormalmode, on pressing "<leader>db", call vim.ls..., on the current buffer, <c-t> brings you back (:help tagstack)
